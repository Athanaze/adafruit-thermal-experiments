...
# printer = Adafruit_Thermal(heatdots=255, heattime=255, heatinterval=255)
time.sleep(5)
# Feel free to experiment with heatdots, heattime and heatiniterval
# to nail down your printer's sweet spot :)
printer = Adafruit_Thermal(heatdots=5, heatinterval=40)
...
printer = Adafruit_Thermal(pins=(4,), heatdots=4, heattime=120, heatinterval=80)
...
printer = Adafruit_Thermal(pins=(4,), heatdots=1, heattime=155, heatinterval=1)
...
printer.feed(3)
# printer.printBitmapFromFile(64, 64, 'bleh')
